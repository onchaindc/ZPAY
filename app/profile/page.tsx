...
export default function ProfilePage() {
  ...
  return (
    <main className="mx-auto w-full max-w-[640px] overflow-x-hidden px-4 pb-28 pt-6 md:max-w-6xl md:px-8 md:py-8">
      <div className="mx-auto mb-7 max-w-2xl text-center md:mb-9">
        ...
        <h1 className="mt-3 text-3xl font-black leading-tight text-white md:text-5xl">Your wallet hub.</h1>
