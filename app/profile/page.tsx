...
export default function ProfilePage() {
  ...
  return (
    <main className="mx-auto w-full max-w-[640px] overflow-x-hidden px-4 pb-20 pt-3 md:max-w-6xl md:px-8 md:pb-5 md:pt-4">
      <div className="mx-auto mb-4 max-w-2xl text-center md:mb-4">
